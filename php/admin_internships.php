...
<a href="admin_dashboard.php" class="nav-item"><span class="icon"><i class="fas fa-chart-pie"></i></span> Overview</a>
        ...
        <a href="admin_internships.php" class="nav-item active"><span class="icon"><i class="fas fa-briefcase"></i></span> Internships</a>
...
<button class="btn btn-secondary export-btn" onclick="exportCSV()"><i class="fas fa-download"></i> Export CSV</button>
        <button class="btn btn-primary" onclick="openModal()"><i class="fas fa-plus"></i> Add Internship</button>
      </div>
    </div>
